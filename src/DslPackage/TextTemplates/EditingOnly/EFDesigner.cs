   ...
   partial class EditOnly
   {
      ...
      List<string> GetRequiredParameterNames(ModelClass modelClass)
      {
         ...
         requiredParameterNames.AddRange(modelClass.AllRequiredNavigationProperties()
                                                   .Where(np => np.AssociationObject.SourceMultiplicity != Multiplicity.One || np.AssociationObject.TargetMultiplicity != Multiplicity.One)
      ...
      void WriteConstructor(ModelClass modelClass)
      {
         ...
         bool hasOneToOneAssociations = modelClass.AllRequiredNavigationProperties()
                                                  .Any(np => np.AssociationObject.SourceMultiplicity == Multiplicity.One && np.AssociationObject.TargetMultiplicity != Multiplicity.One);
      ...
      void WriteProperties(ModelClass modelClass)
      {
         ...
         foreach (ModelAttribute modelAttribute in modelClass.Attributes)
         {
            ...
            string setterVisibility = modelAttribute.ModelClass.ModelRoot.EntityFrameworkVersion == EFVersion.EFCore && modelAttribute.IsIdentity
                                         ? "private "
                                         : modelAttribute.SetterVisibility == SetterAccessModifier.Protected
                                            ? "protected "
